...
class BillmateMethodInvoice extends BillmateGateway
{
    ...
    public function getPaymentInfo($cart)
    {
        ...
        return array(
            ...
            'icon'       => $this->icon,
            'agreements' => '<span>'.$this->module->l(
                'My email is accurate and can be used for invoicing.','invoice') .
                '<br/> <a id="terms" style="cursor:pointer!important">'.
                $this->module->l('I also confirm the terms for invoice payment','invoice') .
                '</a>, <a id="billmate-privacy-policy" href="https://www.billmate.se/integritetspolicy/" target="_blank">'.
                $this->module->l('Privacy Policy', 'invoice').'</a> '.$this->module->l('and accept the liability.','invoice').
                '</span>',
